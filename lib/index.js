...
export default {
  ...
  activate() {
    ...
    this.subscriptions.add(
      ...
      atom.config.observe(displayDockTabsKey, toggleDockTabs),
      atom.config.observe(displayColoredTabsKey, toggleTabColors),
    )
    // observeThemeView()
...
function setProperty(key, val, root='body') {
...
function toggleDockTabs (vis) {
  setProperty('visible', vis, 'atom-dock .tab-bar')
}


function toggleTabColors (vis) {
  writeAttr('tab-coloring', vis)
}
